# -*- coding: utf-8 -*-
#
# Python-Tempo documentation build configuration file, created by
# sphinx-quickstart on Tue Oct  6 15:39:58 2015.
#
...
htmlhelp_basename = 'Python-Tempodoc'
...
latex_documents = [
  (master_doc, 'Python-Tempo.tex', u'Python-Tempo Documentation',
   u'Andrew Pashkin', 'manual'),
]
...
man_pages = [
    (master_doc, 'python-tempo', u'Python-Tempo Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Python-Tempo', u'Python-Tempo Documentation',
   author, 'Python-Tempo', 'One line description of project.',
   'Miscellaneous'),
]
...
class Omit(Directive):
    """Discards it's content."""
